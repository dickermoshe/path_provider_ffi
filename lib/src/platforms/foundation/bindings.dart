...
class NSFileManagerLib {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
  _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  NSFileManagerLib(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NSFileManagerLib.fromLookup(
...
_NSFileManagerLib_protocolTrampoline_1mbt9g9(
...
_NSFileManagerLib_wrapListenerBlock_pfv6jd(
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl>
_NSFileManagerLib_wrapBlockingBlock_pfv6jd(
  ffi.Pointer<objc.ObjCBlockImpl> block,
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl>
_NSFileManagerLib_wrapListenerBlock_xtuoz7(
  ffi.Pointer<objc.ObjCBlockImpl> block,
);
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl>
_NSFileManagerLib_wrapBlockingBlock_xtuoz7(
  ffi.Pointer<objc.ObjCBlockImpl> block,
  ffi.Pointer<objc.ObjCBlockImpl> listnerBlock,
  ffi.Pointer<objc.DOBJC_Context> context,
);
...
abstract final class ObjCBlock_ffiVoid_NSData_NSError {
  ...
  listener(
    ...
    final wrapper = _NSFileManagerLib_wrapListenerBlock_pfv6jd(raw);
  ...
  blocking(
    ...
    final wrapper = _NSFileManagerLib_wrapBlockingBlock_pfv6jd(
      raw,
      rawListener,
      objc.objCContext,
    );
...
abstract final class ObjCBlock_ffiVoid_NSError {
  ...
  static objc.ObjCBlock<ffi.Void Function(objc.NSError?)> listener(
    ...
    final wrapper = _NSFileManagerLib_wrapListenerBlock_xtuoz7(raw);
    objc.objectRelease(raw.cast());
  ...
  static objc.ObjCBlock<ffi.Void Function(objc.NSError?)> blocking(
    ...
    final wrapper = _NSFileManagerLib_wrapBlockingBlock_xtuoz7(
      raw,
      rawListener,
      objc.objCContext,
    );
...
interface class NSFileManagerDelegate extends objc.ObjCProtocolBase
  ...
  NSFileManagerDelegate.castFromPointer(
    ffi.Pointer<objc.ObjCObject> other, {
    bool retain = false,
    bool release = false,
  }) : this._(other, retain: retain, release: release);
...
abstract final class ObjCBlock_bool_NSURL_NSError {
  ...
  fromFunctionPointer(
    ...
    objc.newPointerBlock(
      _ObjCBlock_bool_NSURL_NSError_fnPtrCallable,
      ptr.cast(),
    ),
    retain: false,
    release: true,
...
>
_ObjCBlock_ffiVoid_NSDictionary_NSError_listenerCallable = ffi.NativeCallable<
    ffi.Void Function(
      ffi.Pointer<objc.ObjCBlockImpl>,
      ffi.Pointer<objc.ObjCObject>,
      ffi.Pointer<objc.ObjCObject>,
    )
  >.listener(_ObjCBlock_ffiVoid_NSDictionary_NSError_listenerTrampoline)
  ..keepIsolateAlive = false;
...
>
_ObjCBlock_ffiVoid_NSDictionary_NSError_blockingCallable = ffi.NativeCallable<
    ffi.Void Function(
      ffi.Pointer<objc.ObjCBlockImpl>,
      ffi.Pointer<ffi.Void>,
      ffi.Pointer<objc.ObjCObject>,
  ...
  >.isolateLocal(_ObjCBlock_ffiVoid_NSDictionary_NSError_blockingTrampoline)
  ..keepIsolateAlive = false;
ffi.NativeCallable<
  ffi.Void Function(
    ffi.Pointer<objc.ObjCBlockImpl>,
...
_ObjCBlock_ffiVoid_NSDictionary_NSError_blockingListenerCallable =
    ffi.NativeCallable<
      ...
      >.listener(_ObjCBlock_ffiVoid_NSDictionary_NSError_blockingTrampoline)
      ..keepIsolateAlive = false;
...
abstract final class ObjCBlock_ffiVoid_NSDictionary_NSError {
  ...
  fromFunctionPointer(
    ...
    objc.newPointerBlock(
      _ObjCBlock_ffiVoid_NSDictionary_NSError_fnPtrCallable,
      ptr.cast(),
    ),
    retain: false,
    release: true,
...
class NSFileManager extends objc.NSObject {
  ...
  objc.NSArray? mountedVolumeURLsIncludingResourceValuesForKeys_options_(
    ...
    NSVolumeEnumerationOptions options,
  ) {
    objc.checkOsVersionInternal(
  ...
  objc.NSArray URLsForDirectory_inDomains_(
    ...
    final _ret = _objc_msgSend_12kqj12(
      this.ref.pointer,
  ...
  bool copyItemAtPath_toPath_error_(
    objc.NSString srcPath,
    objc.NSString dstPath,
    ffi.Pointer<ffi.Pointer<objc.ObjCObject>> error,
  ) {
    objc.checkOsVersionInternal(
  ...
  enumeratorAtURL_includingPropertiesForKeys_options_errorHandler_(
    ...
    objc.NSArray? keys,
    NSDirectoryEnumerationOptions mask,
    objc.ObjCBlock<ffi.Bool Function(objc.NSURL, objc.NSError)>? handler,
  ) {
    objc.checkOsVersionInternal(
  ...
  objc.NSObjectProtocol? get ubiquityIdentityToken {
    ...
    return _ret.address == 0
        ? null
        : objc.NSObjectProtocol.castFromPointer(
          _ret,
          retain: true,
          release: true,
        );
  ...
  /// allocWithZone:
  static NSFileManager allocWithZone_(ffi.Pointer<objc.NSZone> zone) {
...
extension NSBundleResourceRequestAdditions on NSBundle {
  ...
  void setPreservationPriority_forTags_(double priority, objc.NSSet tags) {
    ...
    _objc_msgSend_130mcug(
      this.ref.pointer,
      _sel_setPreservationPriority_forTags_,
      priority,
      tags.ref.pointer,
    );
  }
  ...
  double preservationPriorityForTag_(objc.NSString tag) {
    ...
    return objc.useMsgSendVariants
        ? _objc_msgSend_mabicuFpret(
          this.ref.pointer,
          _sel_preservationPriorityForTag_,
          tag.ref.pointer,
        )
...
///
/// NSAttributedString
class NSAttributedString extends objc.ObjCObjectBase {
...
late final _sel_localizedStringForKey_value_table_localizations_ = objc
    .registerName("localizedStringForKey:value:table:localizations:");
...
class NSBundle extends objc.NSObject {
  ...
  /// pathForResource:ofType:inDirectory:
  objc.NSString? pathForResource_ofType_inDirectory_$1(
    objc.NSString? name,
    objc.NSString? ext,
    objc.NSString? subpath,
  ) {
  ...
  /// pathsForResourcesOfType:inDirectory:
  objc.NSArray pathsForResourcesOfType_inDirectory_$1(
    objc.NSString? ext,
    objc.NSString? subpath,
  ) {
    final _ret = _objc_msgSend_15qeuct(
  ...
  objc.NSString localizedStringForKey_value_table_localizations_(
    objc.NSString key,
    objc.NSString? value,
    objc.NSString? tableName,
    objc.NSArray localizations,
  ) {
    objc.checkOsVersionInternal(
  ...
  /// allocWithZone:
  static NSBundle allocWithZone_(ffi.Pointer<objc.NSZone> zone) {
    final _ret = _objc_msgSend_1cwp428(
      _class_NSBundle,
      _sel_allocWithZone_,
      zone,
