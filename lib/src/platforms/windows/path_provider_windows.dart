...
import 'package:path_provider_ffi/src/error.dart';
...
/// The Windows implementation of [PathProvider]
///
/// This class implements the `package:path_provider` functionality for Windows.
class PathProviderWindows extends PathProvider {
  ...
  String? _createApplicationSubdirectory(String folderId) {
    final String? baseDir = getPath(folderId);
    if (baseDir == null) {
      return null;
    }
